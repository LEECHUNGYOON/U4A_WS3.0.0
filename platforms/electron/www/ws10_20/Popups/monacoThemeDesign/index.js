...
module.exports = function(REMOTE, oAPP, sEditorSettings){
    ...
    // 팝업 고유 이름
    let sPopupName = "monacoThemeDesign";
    ...
    let sSettingsJsonPath = parent.getPath("BROWSERSETTINGS"),
        ...
        //341   monaco Theme Designer
        oBrowserOptions.title = parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "341");
        ...
        oBrowserWindow.webContents.on('did-finish-load', function () {
            ...
            let oOptionData = {
                ...
                sEditorSettings : sEditorSettings,        //function 호출 파라메터 정보.

            };
            
            oBrowserWindow.webContents.send('if_p13nMonacoEditor', oOptionData);
