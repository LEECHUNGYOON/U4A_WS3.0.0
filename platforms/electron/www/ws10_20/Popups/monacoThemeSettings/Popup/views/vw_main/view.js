 ...
 ************************************************************************/
    ...
    //317	Standard Theme
    const C_STANDARD_THEME = parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "317");

    //318	Custom Theme
    const C_CUSTOM_THEME = parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "318");
 ...
 ************************************************************************/
    ...
    //001	Language
    var _text = parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "001");
    ...
    var WIZARD1 = new sap.m.Wizard({
        //315	Save
        finishButtonText:parent.WSUTIL.getWsMsgClsTxt("EN", "ZMSG_WS_COMMON_001", "315"),
        height:"100%",
    ...
    var WIZARDSTEP1 = new sap.m.WizardStep({
        //316	Choose theme
        title:parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "316")        
    });
    ...
    var WIZARDSTEP2 = new sap.m.WizardStep({
        ...
        title:parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "319")
    });
    ...
    var PANEL1 = new sap.m.Panel({
        ...
        expanded : true,
        //320	Rules
        headerText : parent.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "320")
