...
(function (oWS) {
    ...
    oWS.utill.fn.onNewWindow = function () {
        ...
        //     x: 0,
        //     y: 0,
        //     width: oParentBounds.width,
        //     height: oParentBounds.height
        // };

        // oNewBound.x = Math.round(x + inc);
        ...
        // oBrowserWindow.setBounds(oNewBound);
        ...
        //  var oScr1 = SCREEN.getDisplayMatching(oParentBounds);
        // //  var oScr1 = SCREEN.screenToDipRect(CURRWIN, oParentBounds);
        // //  var oScr2 = SCREEN.dipToScreenRect(CURRWIN, oScr1);


        // var oParentBounds = CURRWIN.getBounds(),
        //     oRect = SCREEN.screenToDipRect(CURRWIN, oParentBounds);

        // oRect.x += 30;
        // oRect.y += 30;

        // oBrowserWindow.setBounds(oRect);
