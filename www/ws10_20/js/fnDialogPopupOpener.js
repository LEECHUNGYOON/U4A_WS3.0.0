...
(function(window, $, oAPP) {
    ...
    oAPP.fn.fnUspPatternPopupOpener = () => {
        ...
        let oServerInfo = parent.getServerInfo(), // 서버 정보
            ...
            sDefaultPatternJsonPath = parent.getPath("DEF_PATT"), // Default Pattern Json Path
            sCustomPatternJsonPath = parent.getPath("CUST_PATT"); // Custom Pattern Json Path
        ...
        oBrowserWindow.webContents.on('did-finish-load', function() {
            ...
            let oOptionData = {
                ...
                sDefaultPatternJsonPath: sDefaultPatternJsonPath,
                sCustomPatternJsonPath: sCustomPatternJsonPath
            };
