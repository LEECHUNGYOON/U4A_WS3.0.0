...
******************************************************************************/
    ...
    //333	Light Theme
    const C_LIGHT_THEME = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "333");

    //334	Dark Theme
    const C_DARK_THEME = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "334");
...
******************************************************************************/
    ...
    *************************************************************/
    ...
    oContr.fn.setInitData = function(){
        ...
        //(p13n/monaco/theme/UHA/usp_main/list)
        oContr.attr.customThemePath = oAPP.PATH.join(parent.PATHINFO.P13N_ROOT, "monaco", 
            "theme", parent.USERINFO.SYSID, oAPP.attr.oOptionData.sEditorSettings.scopeCode, "list");
    ...
    oContr.fn.onSaveTheme = async function(){
        ...
        let _conf = await new Promise(function(resolve){
            ...
            sap.m.MessageBox.confirm(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "329"), function(param){
                resolve(param);
            });
        });
        ...
        if(oAPP.FS.existsSync(oContr.attr.customThemePath) === false){

            try {
                //생성되지 않은 경우 커스텀 테마 저장 경로의 폴더 생성 처리.
                oAPP.FS.mkdirSync(oContr.attr.customThemePath, { recursive: true });

            } catch (error) {
                //342	Failed to create theme save path, please try again later. If the problem persists, contact your admin.
                sap.m.MessageBox.error(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "342"));     //$msg
                oAPP.fn.setBusy("");
                return;   
            }
        ...
        try {
            ...
            //330	Failed to save the theme settings. Please try again later. If the problem persists, contact your administrator.
            sap.m.MessageBox.error(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "330"));     //$msg
            oAPP.fn.setBusy("");
            return;   
        }
        ...
        sap.m.MessageToast.show(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "331"), 
    ...
    oContr.fn.onResetThemeData = function(){
        ...
        sap.m.MessageToast.show(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "332"), 
            {my:"center center", at:"center center"});
    ...
    oContr.fn.checkThemeName = function(){
        ...
        if(oContr.oModel.oData.S_THEME.NAME === ""){
            ...
            var _msg = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "335");

            oContr.oModel.oData.S_THEME.NAME_VS = "Error";
            oContr.oModel.oData.S_THEME.NAME_VT = _msg;
    ...
    oContr.fn.checkCustomThemeName = function(){
        ...
        if(_S_THEME.CUSTOM_NAME === ""){
            ...
            var _msg = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "336");
        ...
        if(_oReg.test(_S_THEME.CUSTOM_NAME) === true){
            ...
            var _msg = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "337");
        ...
        if(oContr.oModel.oData.T_THEME.findIndex( item => item.TEXT.toLowerCase() === _CUSTOM_NAME && item.IS_STANDARD === true ) !== -1){
            ...
            var _msg = oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "338");
    ...
    oContr.fn.setThemeDetailData = function(){
        ...
        try {
            ...
            //339	Failed to load custom theme settings. Please try again later. If the issue persists, contact your administrator.
            sap.m.MessageBox.error(oAPP.WSUTIL.getWsMsgClsTxt("", "ZMSG_WS_COMMON_001", "339"));
            oAPP.fn.setBusy("");
            return;
        }
